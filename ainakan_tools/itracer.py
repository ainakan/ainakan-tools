...
import ainakan
from ainakan.core import RPCException
...
class InstructionTracer:
    ...
    def __init__(self, reactor: Reactor) -> None:
        ...
        self._tracer_script: Optional[ainakan.core.Script] = None
        self._reader_script: Optional[ainakan.core.Script] = None
    ...
    def start(
        self, device: ainakan.core.Device, session: ainakan.core.Session, runtime: str, ui: InstructionTracerUI
    ) -> None:
