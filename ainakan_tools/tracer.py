...
def main() -> None:
    ...
    class TracerApplication(ConsoleApplication, UI):
        ...
        def on_script_created(self, script: ainakan.core.Script) -> None:
...
class Tracer:
    ...
    def start_trace(self, session: ainakan.core.Session, stage, parameters, runtime, ui: UI) -> None:
        ...
        source = (
            (data_dir / "tracer_agent.js").read_text(encoding="utf-8").replace("/agent.js", "/ainakan/tracer/agent.js", 1)
        )
...
class Repository:
    ...
    def _create_stub_instruction_handler(self, target: TraceTarget, decorate: bool) -> str:
        return """\
/*
 * Auto-generated by Ainakan.
 *
 * For full API reference, see: https://ainakan.re/docs/javascript-api/
 */
...
""" % {
    ...
    def _create_stub_native_handler(self, target: TraceTarget, decorate: bool) -> str:
        ...
        return """\
/*
 * Auto-generated by Ainakan. Please modify to match the signature of %(display_name)s.
...
class FileRepository(Repository):
    ...
    def _ensure_monitor(self, handler_file: Path) -> None:
        ...
        if monitor is None:
            monitor = ainakan.FileMonitor(str(handler_dir))
