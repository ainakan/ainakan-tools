...
from ainakan_tools.application import ConsoleApplication, await_enter
from ainakan_tools.model import Function, Module, ModuleFunction
...
class Discoverer:
    ...
    def start(self, session: ainakan.core.Session, runtime: str, ui: UI) -> None:
